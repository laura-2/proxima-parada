            ...
            <h5 className="my-2 text-center text-2xl font-bold text-amber-500">LOGIN</h5>
                ...
                <Formik initialValues={{}} onSubmit={handleClickLogin}>
                    <Form className="block">
                                ...
                                <Field type="email"  onChange={(e)=> [setEmail(e.target.value), setError("")]} value={email} name="email" placeholder="joaosilva@gmail.com" className="border-2 border-solid border-black py-2 px-5 rounded-xl my-2 w-2/3 md:w-1/3" required></Field>
                                <ErrorMessage
                                value={error}
                        component="span"
                        name="email"
                        />
                                ...
                                <Field type="password"  onChange={(e)=> [setSenha(e.target.value), setError("")]} value={senha} name="senha" placeholder="*******" className="border-2 border-solid border-black py-2 px-5 rounded-xl my-2 w-2/3 md:w-1/3" required minLength="8"></Field>
                                <ErrorMessage
                                value={error}
                        component="span"
                        name="senha"
